...
kable_styling(kable(x =
                        ...
                        ), format = "latex", caption = "P-values for test of phylogenetic signal (D) of each mycorrhizal type."), latex_options = "HOLD_position")
...
kable_styling(kable(x = data.frame(Threshold = c(50, 60, 80, 100),
                                   F_r0 = c(phyaov.r0.50$F,
                                            phyaov.r0.60$F,
                                            phyaov.r0.80$F,
                                            phyaov.r0.100$F),
                                   pvalue_r0 = c(phyaov.r0.50$Pf,
                                                 phyaov.r0.60$Pf,
                                                 phyaov.r0.80$Pf,
                                                 phyaov.r0.100$Pf),
                                   F_r09 = c(phyaov.r09.50$F,
                                            phyaov.r09.60$F,
                                            phyaov.r09.80$F,
                                            phyaov.r09.100$F),
                                   pvalue_r09 = c(phyaov.r09.50$Pf,
                                                 phyaov.r09.60$Pf,
                                                 phyaov.r09.80$Pf,
                                                 phyaov.r09.100$Pf)
                                   ), format = "latex", caption = "Summary statistics for phyANOVA for both values of epsilon"), latex_options = "HOLD_position")
...
kable_styling(kable(x = data.frame(Threshold = c(50, 60, 80, 100),
                                   F_r0 = c(summary(aov.r0.50)[[1]]$F[1],
                                            summary(aov.r0.60)[[1]]$F[1],
                                            summary(aov.r0.80)[[1]]$F[1],
                                            summary(aov.r0.100)[[1]]$F[1]),
                                   pvalue_r0 = c(summary(aov.r0.50)[[1]]$P[1],
                                                 summary(aov.r0.60)[[1]]$P[1],
                                                 summary(aov.r0.80)[[1]]$P[1],
                                                 summary(aov.r0.100)[[1]]$P[1]),
                                   F_r09 = c(summary(aov.r09.50)[[1]]$F[1],
                                            summary(aov.r09.60)[[1]]$F[1],
                                            summary(aov.r09.80)[[1]]$F[1],
                                            summary(aov.r09.100)[[1]]$F[1]),
                                   pvalue_r09 = c(summary(aov.r09.50)[[1]]$P[1],
                                                 summary(aov.r09.60)[[1]]$P[1],
                                                 summary(aov.r09.80)[[1]]$P[1],
                                                 summary(aov.r09.100)[[1]]$P[1])
                                   ), format = "latex", caption = "summary statistics for standard ANOVA for both values of epsilon"), latex_options = "HOLD_position")
...
kable_styling(kable(x = sum.phyaov,
                    format = "latex", caption = "Pairwise Corrected p-values for phyANOVA", row.names = FALSE), latex_options = "HOLD_position")
...
kable_styling(kable(x = sum.aov,
                    format = "latex", caption = "Pairwise Corrected p-values for standard ANOVA", row.names = FALSE), latex_options = "HOLD_position")
...
kable_styling(kable(x =
                        data.frame(Threshold = c(50, 60, 80, 100),
                                   F_r0 = c(summary(aov.r0.50)[[1]]$F[1],
                                            summary(aov.r0.60)[[1]]$F[1],
                                            summary(aov.r0.80)[[1]]$F[1],
                                            summary(aov.r0.100)[[1]]$F[1]),
...
kable_styling(kable(x = data.frame(epsilon = c(0, 0.9),
                                   pvalue_PGLS = c(4.637e-08, 6.858e-08),
                                   R2_PGLS = c(0.07343, 0.07157),
                                   pvalue_LM = c(6.325e-10, 4.512e-09),
                                   R2_LM = c(0.09319, 0.08402)), format = "latex", caption = "Summary statistics for the phylogenetic and parametric regressions using the full genus dataset.", longtable = TRUE), latex_options = "HOLD_position")
...
kable_styling(kable(x = data.frame(Threshold = c("50%", "60%", "80%", "100%"),
                                   rbind(table(family.data.gen$type.50), table(family.data.gen$type.60), table(family.data.gen$type.80), table(family.data.gen$type.100))), format = "latex", caption = "Mycorrhizal type assigned to each family based on 4 different percentage thresholds (50, 60, 80 and 100)", longtable = TRUE), latex_options = "HOLD_position")
...
kable_styling(kable(x = data.frame(epsilon = c(0, 0.9),
                                   pvalue_PGLS = c(4.063e-07, 3.483e-07),
                                   R2_PGLS = c(0.08904, 0.09007),
                                   pvalue_LM = c(1.676e-07, 2.844e-07),
                                   R2_LM = c(0.09458, 0.09109)), format = "latex", caption = "Summary statistics for the phylogenetic and parametric regressions using the full genus dataset.", longtable = TRUE), latex_options = "HOLD_position")
...
kable_styling(kable(x = data.frame(Threshold = c(50, 60, 80, 100),
                                   F_r0 = c(phyaov.r0.50.rem$F,
                                            phyaov.r0.60.rem$F,
                                            phyaov.r0.80.rem$F,
                                            phyaov.r0.100.rem$F),
                                   pvalue_r0 = c(phyaov.r0.50.rem$Pf,
                                                 phyaov.r0.60.rem$Pf,
                                                 phyaov.r0.80.rem$Pf,
                                                 phyaov.r0.100.rem$Pf),
                                   F_r09 = c(phyaov.r09.50.rem$F,
                                            phyaov.r09.60.rem$F,
                                            phyaov.r09.80.rem$F,
                                            phyaov.r09.100.rem$F),
                                   pvalue_r09 = c(phyaov.r09.50.rem$Pf,
                                                 phyaov.r09.60.rem$Pf,
                                                 phyaov.r09.80.rem$Pf,
                                                 phyaov.r09.100.rem$Pf)
                                   ), format = "latex", caption = "summary statistics for phyANOVA for both values of epsilon"), latex_options = "HOLD_position")
...
kable_styling(kable(x =
                        data.frame(Threshold = c(50, 60, 80, 100),
                                   F_r0 = c(summary(aov.r0.50.rem)[[1]]$F[1],
                                            summary(aov.r0.60.rem)[[1]]$F[1],
                                            summary(aov.r0.80.rem)[[1]]$F[1],
                                            summary(aov.r0.100.rem)[[1]]$F[1]),
                                   pvalue_r0 = c(summary(aov.r0.50.rem)[[1]]$P[1],
                                                 summary(aov.r0.60.rem)[[1]]$P[1],
                                                 summary(aov.r0.80.rem)[[1]]$P[1],
                                                 summary(aov.r0.100.rem)[[1]]$P[1]),
                                   F_r09 = c(summary(aov.r09.50.rem)[[1]]$F[1],
                                            summary(aov.r09.60.rem)[[1]]$F[1],
                                            summary(aov.r09.80.rem)[[1]]$F[1],
                                            summary(aov.r09.100.rem)[[1]]$F[1]),
                                   pvalue_r09 = c(summary(aov.r09.50.rem)[[1]]$P[1],
                                                 summary(aov.r09.60.rem)[[1]]$P[1],
                                                 summary(aov.r09.80.rem)[[1]]$P[1],
                                                 summary(aov.r09.100.rem)[[1]]$P[1])
                                   ), format = "latex", caption = "summary statistics for phyANOVA for both values of epsilon"), latex_options = "HOLD_position")
...
kable_styling(kable(x = sum.phyaov, format = "latex", caption = "Pairwise Corrected p-values for phyANOVA", row.names = FALSE), latex_options = "HOLD_position")
...
kable_styling(kable(x = data.frame(epsilon = c(0, 0.9),
                                   pvalue_PGLS = c(5.265e-05, 4.013e-05),
                                   R2_PGLS = c(0.06444, 0.06653),
                                   pvalue_LM = c(2.528e-07, 4.977e-07),
                                   R2_LM = c(0.09354, 0.08898)), format = "latex", caption = "Summary statistics for the phylogenetic and parametric regressions using the full genus dataset.", longtable = TRUE), latex_options = "HOLD_position")
