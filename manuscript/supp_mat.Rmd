...
np.sum <-
    data.frame(model = c("Phylogenetic", "Linear"),
                     pvalue.r0 = c("\\textbf{2.724e-13}", "\\textbf{1.345e-14}"),
                     R2.r0 = c(0.1349, 0.1464),
                     pvalue.r09 = c("\\textbf{3.581e-13}", "\\textbf{1.228e-14}"),
                     R2.r09 = c(0.1336, 0.1468),
                     pvalue.r0 = c("\\textbf{0.0005}", "\\textbf{0.019}"),
                     pvalue.r09 = c("\\textbf{0.0003}", "\\textbf{0.02}")
                     )
