...
library("patchwork")
rm(list = ls())
here::i_am("manuscript/supp_mat.Rmd")
...
pvalue.reg <- read.csv("../output/results_20perc.csv")

pvalue.20perc.reg <-
    ggplot(data = pvalue.reg) +
    geom_histogram(aes(x = log10(pgls.pvalue.r09), y = ..density.., fill = RColorBrewer::brewer.pal(3, "Set1")[2]), alpha = 0.3, colour = "white") +
    geom_histogram(aes(x = log10(lm.pvalue.r09), y = ..density.., fill = RColorBrewer::brewer.pal(3, "Set1")[1]), alpha = 0.3, colour = "white") +
...
load("../output/side_analysis_rabosky_benson_5perc.RData")
...
load("../output/side_analysis_rabosky_benson_20perc.RData")
...
load("../output/side_analysis_rabosky_benson_50perc.RData")
