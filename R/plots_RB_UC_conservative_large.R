...
load("../output/RB_results_UC_conservative_large.RData")
nrep <- 10000
fullresults <- ldply(1:nrep, function(x){results.UC.conservative.large[[x]][[1]]})
...
ggsave(filename = "../output/figs/scatterplots_lm_pgls_stem_r09_UC_conservative_large.pdf", height = 5.5, width = 13)
...
ggsave(filename = "../output/figs/scatterplots_lm_pgls_stem_age_UC_conservative_large.pdf", height = 5.5, width = 13)
...
ggsave(filename = "../output/figs/scatterplots_lm_pgls_stem_rich_UC_conservative_large.pdf", height = 5.5, width = 13)
...
ggsave(filename = "../output/figs/box_hist_anova_myctype_r09_UC_conservative_large.pdf", width = 11, height = 9, units = "in")
...
ggsave(filename = "../output/figs/jitter_pvalue_anovas_r09_UC_conservative_large.pdf", anovas.r09.pvalue, width = 11, height = 5.5, units = "in")
