...
age.data$familia[age.data$familia == "Asteraceae"] <- "Compositae"
age.data$familia[age.data$familia == "Fabaceae"] <- "Leguminosae"
...
tree$tip.label[grep("Fabaceae", tree$tip.label)] <- "Leguminosae"
tree$tip.label[grep("Asteraceae", tree$tip.label)] <- "Compositae"
...
p <-
    ggtree::ggtree(tr = tree, layout = "fan", open.angle = 10) +
