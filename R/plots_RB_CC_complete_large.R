...
load("../output/RB_results_CC_complete_large.RData")
nrep <- 10000
fullresults <- ldply(1:nrep, function(x){results.CC.complete.large[[x]][[1]]})
...
family.data.gen$stem.age <- age.data$rb.CC.complete.stem[match(family.data.gen$family, age.data$familia)]
...
ggsave(filename = "../output/figs/scatterplots_lm_pgls_stem_r09_CC_complete_large.pdf", height = 5.5, width = 13)
...
ggsave(filename = "../output/figs/scatterplots_lm_pgls_stem_age_CC_complete_large.pdf", height = 5.5, width = 13)
...
ggsave(filename = "../output/figs/scatterplots_lm_pgls_stem_rich_CC_complete_large.pdf", height = 5.5, width = 13)
...
ggsave(filename = "../output/figs/boxplots_anova_myctype_r09_CC_complete.pdf", box.r09, width = 11, height = 5.5, units = "in")
...
ggsave(filename = "../output/figs/box_hist_anova_myctype_r09_CC_complete_large.pdf", width = 11, height = 9, units = "in")
...
ggsave(filename = "../output/figs/jitter_pvalue_anovas_r09_CC_complete_large.pdf", anovas.r09.pvalue, width = 11, height = 5.5, units = "in")
