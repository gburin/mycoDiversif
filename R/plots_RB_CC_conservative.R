...
load("../output/RB_results_CC_conservative.RData")
nrep <- 10000
fullresults <- ldply(1:nrep, function(x){results.CC.conservative[[x]][[1]]})
...
ggsave(filename = "../output/figs/scatterplots_lm_pgls_stem_r09_CC_conservative.pdf", height = 5.5, width = 13)
...
ggsave(filename = "../output/figs/scatterplots_lm_pgls_stem_age_CC_conservative.pdf", height = 5.5, width = 13)
...
ggsave(filename = "../output/figs/scatterplots_lm_pgls_stem_rich_CC_conservative.pdf", height = 5.5, width = 13)
...
ggsave(filename = "../output/figs/box_hist_anova_myctype_r09_CC_conservative.pdf", width = 11, height = 9, units = "in")
...
ggsave(filename = "../output/figs/jitter_pvalue_anovas_r09_CC_conservative.pdf", anovas.r09.pvalue, width = 11, height = 5.5, units = "in")
