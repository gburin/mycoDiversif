...
RB.tree.UC.conservative <- read.nexus("../data/ramirez_barahona_data/ramirez_barahona_UC_complete_MCCv_2.tre")
...
rb.UC.conservative.ages <- read.csv("../data/ramirez_barahona_data/ramirez_barahona_Ages_UC_complete.csv", as.is = TRUE)
...
load("../output/RB_results_UC_complete.RData")
nrep <- 10000
...
ggsave(filename = "../output/figs/scatterplots_lm_pgls_stem_r09_UC_complete.pdf", height = 5.5, width = 13)
...
ggsave(filename = "../output/figs/scatterplots_lm_pgls_stem_age_UC_complete.pdf", height = 5.5, width = 13)
...
ggsave(filename = "../output/figs/scatterplots_lm_pgls_stem_rich_UC_complete.pdf", height = 5.5, width = 13)
...
ggsave(filename = "../output/figs/box_hist_anova_myctype_r09_UC_complete.pdf", width = 11, height = 9, units = "in")
...
ggsave(filename = "../output/figs/jitter_pvalue_anovas_r09_UC_complete.pdf", anovas.r09.pvalue, width = 11, height = 5.5, units = "in")
